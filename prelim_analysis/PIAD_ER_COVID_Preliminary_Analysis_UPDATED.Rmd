...
packages <- c("haven", "here", "dplyr", "purrr", "broom", "knitr", "kableExtra", "ggplot2", "performance", "see", "report", "gt", "parameters", "ggpubr")
...
```{r stdint_35_quad}
mdl <- lm(BITSEA_Prob_Total_35M ~ (COVID_Comp_Total_std + I(COVID_Comp_Total^2)) * DERS_Total_std, data=df)
print_html(model_parameters(mdl), summary = TRUE)
print_html(model_performance(mdl), summary = TRUE)
